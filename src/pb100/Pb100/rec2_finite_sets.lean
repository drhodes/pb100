...
section finite_sets_1

-- note: This worksheet was copied from Kevin Buzzards course located at the
-- following link:
...
-- sets is finite?
example (X : Type) (S T : Set X) (hs : Set.Finite S) (ht : T.Finite) : (S ∪ T).Finite := by
